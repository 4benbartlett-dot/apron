...
export const metadata: Metadata = {
  title: "NBA CBA Rules Coverage & Accuracy — 240 Tests Against the 2023 CBA | Over the Apron",
  description:
    "Exactly which 2023 CBA rules the trade machine enforces, what's approximate, and what isn't modeled — verified by 240 unit tests and real July 2026 move replays.",
};
  ...
  return (
    <div>
      <div className="mb-5 flex flex-wrap items-start justify-between gap-4">
        ...
        <span className="stamp stamp-in mt-1 text-[13px] text-[var(--tier-below_cap)]">Audited · 240 tests</span>
      </div>
