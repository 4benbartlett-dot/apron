...
export const metadata: Metadata = {
  title: "NBA CBA Rules Coverage & Accuracy — 189 Tests Against the 2023 CBA | Over the Apron",
  description:
    "Exactly which 2023 CBA rules the trade machine enforces, what's approximate, and what isn't modeled — verified by 189 unit tests and real July 2026 move replays.",
};
    ...
    <div>
      <div className="mb-5 flex flex-wrap items-start justify-between gap-4">
        ...
        <p className="mt-1 text-sm text-[var(--muted)]">
          ...
          verified by 189 unit tests against the CBA's own text, and by replaying real 2026 free-agency moves through the engine. No hand-waving.
        </p>
        </div>
        <span className="stamp stamp-in mt-1 text-[13px] text-[var(--tier-below_cap)]">Audited · 189 tests</span>
      </div>
